######################################################################################
# Title: GEOAssist Agent V3.0 - An open-source autonomous research agent for geoscience data and literature. 
...
def _draw_points_on_country_map(country: str,
    ...
    W, H = size
    to_px = _projector(W, H, bbox)  
    
    base = None
    if imagery:  
        try:
            # Requires proc _satellite_mosaic_for_bbox(bbox, size, provider)
